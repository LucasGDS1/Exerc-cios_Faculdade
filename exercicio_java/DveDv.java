...
* Descrição: Exercício 2) E - Ler quatro valores  inteiros e

* Apresentar, somente os que forem divisíveis por 2 e 3
...
public class DveDv
{
	// Método de acesso;
	 public static void main(String[] args){
		...
		if((vl1 %2 == 0) && (vl1 %3 == 0))
		{
			System.out.println("O nmr divisivel por 2 e 3 é: "+vl1);
		}
			
		// Condição para o segundo valor;
		if((vl2 %2 == 0) && (vl2 %3 == 0))
		{
			System.out.println("O nmr divisivel por 2 e 3 é: "+vl2);
		}

		// Condição para o terceiro valor;
		if((vl3 %2 == 0) && (vl3 %3 == 0))
		{
			System.out.println("O nmr divisivel por 2 e 3 é: "+vl3);
		}

		// Condição para o quarto valor;
		if((vl4 %2 == 0) && (vl4 %3 == 0))
		{
			System.out.println("O nmr divisivel por 2 e 3 é: "+vl4);
		}
	}
}